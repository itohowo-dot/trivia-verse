import trivia-verseGameV2ABI from './trivia-verseGameV2ABI.json';

// Contract addresses
export const CONTRACTS = {
  trivia-verseGameV2: {
    address: (process.env.NEXT_PUBLIC_trivia-verse_GAME_V2_ADDRESS || '0x80B56E7ac1841a3b099c13f85c8A092759E2909c') as `0x${string}`,
    abi: trivia-verseGameV2ABI,
  },
  mockVRF: {
