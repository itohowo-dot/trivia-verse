...
import {trivia-verseGame} from "../src/SimpleTriviaGame.sol";

/**
 * @title DeploySimpleMainnet
 * @dev Quick deployment script for trivia-verseGame on Base Mainnet
...
contract DeploySimpleMainnet is Script {
    ...
    function run() external {
        ...
        console.log("========================================");
        console.log("DEPLOYING trivia-verseGame to BASE MAINNET");
        console.log("========================================");
        ...
        // Deploy trivia-verseGame
        trivia-verseGame game = new trivia-verseGame(USDC_MAINNET);
        console.log("\ntrivia-verseGame deployed to:", address(game));
